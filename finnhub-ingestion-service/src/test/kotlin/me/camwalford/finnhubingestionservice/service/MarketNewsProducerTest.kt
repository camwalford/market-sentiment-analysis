...
// TODO: Fix this to work with ByteArray
...
//    val sendResult = SendResult(ProducerRecord(topic, key, marketNewsList.toByteArray()), RecordMetadata(TopicPartition(topic, 0), 0, 0, 0, 0, 0))
//    val future = CompletableFuture.completedFuture(sendResult)
//    every { kafkaTemplate.send(topic, key, marketNewsList.toByteArray()) } returns future
//
//    // Act
//    marketNewsProducer.sendMarketNews(marketNewsList)
//
//    // Assert
//    verify { kafkaTemplate.send(topic, key, marketNewsList.toByteArray()) }
//  }
//
//  @Test
